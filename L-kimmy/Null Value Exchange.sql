DECLARE @QSKU as nvarchar(50); -- This process will be combined at same query of "Extract two-year sales by SKU"
Set @QSKU = 'APL2126';         -- I created this query in order to put missing SKU sales that are not sold in specific month to value 0
